...
import profileMale from '../assets/icons/profile-male.png'
import profilefemale from '../assets/icons/profile-female.png'
      ...
      <div className="justify-center items-center flex overflow-x-hidden fixed inset-0 z-50 outline-none focus:outline-none">
        <div className="w-[30em] relative my-8 mx-auto">
          <div className='w-full bg-white rounded-lg'>
            <div className='w-full h-10 flex flex-row justify-start text-center items-center py-8 px-5 border-b border-solid border-slate-200 rounded-b'>
            ...
            <div className='w-full h-full flex flex-col'>
              ...
              <div className='w-full text-center py-2'>
                ...
                <p className='text-xl'>Professional Dentist</p>
              ...
              <div className='w-full text-center px-5 py-2 mb-5'>
